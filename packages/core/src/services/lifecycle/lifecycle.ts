...
/**
 * This enum defines multiple lifecycle stages in Termlnk SDK.
 */
export enum LifecycleStages {
  /**
   * Register plugins to Termlnk.
   */
  Starting = 0,

  /**
   * Termlnk business instances are created and services or controllers provided by
